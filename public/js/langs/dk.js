editAreaLoader.lang["dk"] = {
  ...
  change_smooth_selection:
    "sl&aring; display funktioner til/fra (smartere display men mere CPU kr&aelig;vende)",
  highlight: "sl&aring; syntax highlight til/fra",
  reset_highlight:
    "nulstil highlight (hvis den er desynkroniseret fra teksten)",
  ...
  about_notice:
    "Husk: syntax highlight funktionen b&oslash;r kun bruge til sm&aring; tekster",
