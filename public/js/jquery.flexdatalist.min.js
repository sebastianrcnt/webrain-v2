    ...
    (this.init = function () {
      ...
      (this.set = {
        up: function () {
          (l = this.alias()),
            i.options.get("multiple")
              ...
              : l.insertAfter(t),
            t.attr("autofocus") && l.focus(),
            t
              .data("aliascontainer", o ? o : l)
        ...
        multipleInput: function (e) {
          return (
            (o = $('<ul tabindex="1">')
              .addClass("flexdatalist-multiple " + s)
              .css({
      ...
      (this.fvalue = {
        ...
        _load: function (e, t, a) {
          ...
          return (
            ...
            0 == s.length && 0 == l.length
              ? void t(e)
              : ((e = this.toObj(e)),
                i.isEmpty(e) || i.isEmpty(n) || "*" === n
                  ? (t(e), void i.fvalue.extract(e, a))
                  : (i.isObject(n) || (n = n.split(",")),
        ...
        extract: function (e, a) {
          ...
          a || t.trigger("before:flexdatalist.value", [e, r]),
            $.isArray(e)
              ...
              : (n = i.fvalue._extract(e)),
            a ||
              t
                .trigger("after:flexdatalist.value", [n, r])
                .trigger("change:flexdatalist", [n, r])
                .trigger("change");
        },
        _extract: function (e) {
          var t = this.text(e),
        ...
        multiple: {
            ...
            if (a.toggleSelected) {
              ...
              if (r) {
                var n = r.index(),
                  ...
                  o = i.fvalue.get(),
                  u = [{ value: s.value, text: s.text, action: l }, a];
                if (
                  (t.trigger("before:flexdatalist.toggle", u), "enable" === l)
                ) {
                  var f = r.data("value");
                ...
                (o = i.fvalue.toStr(o)),
                  (i.value = o),
                  t
                    .trigger("after:flexdatalist.toggle", u)
                    .trigger("change:flexdatalist", u)
                    .trigger("change");
              }
            }
          },
          remove: function (e) {
            ...
            if (t) {
              var a = i.fvalue.get(),
                r = t.index(),
                s = t.data(),
                l = (i.options.get(), { value: s.value, text: s.text });
              return (
                a.splice(r, 1),
                (a = i.fvalue.toStr(a)),
                (i.value = a),
                t.remove(),
                i.fvalue.multiple.checkLimit(),
                n.splice(r, 1),
                l
              );
            }
          ...
          li: function (e, t) {
            ...
            return $("<li>")
              .addClass(
                "value" + (i.options.get("toggleSelected") ? " toggle" : "")
              )
              .append('<span class="text">' + t + "</span>")
              .append('<span class="fdl-remove">&times;</span>')
              .data({ text: t, value: i.fvalue.toObj(e) })
              .insertBefore(a);
          },
          checkLimit: function () {
        ...
        clear: function (e, a) {
          var r = i.value,
            s = i.options.get();
          return (
            s.multiple && this.multiple.removeAll(),
            (i.value = ""),
            "" === r ||
              a ||
              t
                .trigger("change:flexdatalist", [{ value: "", text: "" }, s])
                .trigger("change"),
            e && (l[0].value = ""),
            (n = []),
            this
        ...
        toObj: function (e) {
          if ("object" != typeof e) {
            ...
            i.isEmpty(e) || !i.isDefined(e)
              ...
              : this.isCSV()
              ? ((e = e.toString().split(t.valuesSeparator)),
                (e = $.map(e, function (e) {
                  return $.trim(e);
                })))
              : (this.isMixed() || this.isJSON()) && this.isJSON(e)
              ? (e = JSON.parse(e))
      ...
      (this.data = {
        ...
        url: function (e, t) {
          ...
          var f = i.cache.keyGen(
              { relative: o, load: t, keyword: a, contain: r.searchContain },
              r.url
            ),
            c = i.cache.read(f, !0);
          ...
          (d[n] = a),
            this.remote({
              ...
              success: function (t) {
                var n = l.val();
                n.length >= a.length && e(t),
                  i.cache.write(f, t, r.cacheLifetime, !0);
              },
            });
        },
        remote: function (e) {
      ...
      (this.search = {
        get: function (e, a, r) {
          ...
          if (s.searchDisabled) l = a;
            ...
            if (!l) {
              ...
              i.cache.write(e, l, 2),
                t.trigger("after:flexdatalist.search", [e, a, l]);
            }
          }
          r(l);
        },
        matches: function (e, t) {
          ...
          if (t.length > 0)
            for (var l = 0; l < s.length; l++) {
              ...
              if (i.isDefined(e, o) && e[o]) {
                for (
                  var u = e[o].toString(), f = u, c = this.split(u), d = 0;
                  d < t.length;
                  d++
                ) {
                  var h = t[d];
          ...
          return 0 === r.length || (n.searchByWord && r.length < t.length - 1)
            ? !1
            : a;
        },
        ...
        find: function (e, t) {
          for (var a = i.options.get(), r = 0; r < t.length; r++) {
            var n = t[r];
            if (
              ((n = this.normalizeString(n)),
              (e = this.normalizeString(e)),
              a.searchEqual)
            )
              return n == e;
            if (a.searchContain ? n.indexOf(e) >= 0 : 0 === n.indexOf(e))
              return !0;
          }
          return !1;
        },
      ...
      (this.results = {
            ...
            r.groupBy
              ? ((e = this.group(e)),
                Object.keys(e).forEach(function (t) {
                  ...
                  $("<li>")
                    .addClass("group")
                    .append($("<span>").addClass("group-name").html(o))
                    .append(
                      $("<span>")
            ...
            s
              .on("click", function () {
                ...
                e &&
                  (i.fvalue.extract(e),
                  a.remove(),
                  t.trigger("select:flexdatalist", [e, r]));
              })
              .hover(
                function () {
        ...
        item: function (e) {
          for (
            var t = $("<li>").data("item", e).addClass("item"),
              a = i.options.get(),
              r = a.visibleProperties,
              n = 0;
            n < r.length;
            n++
          ) {
            ...
            if (s.indexOf("{") > -1) {
              ...
              u = $("<span>")
                .addClass("item item-" + Object.values(o).join("-"))
                .html(l + " ")
                .appendTo(t);
            } else {
              if ((a.groupBy && a.groupBy === s) || !i.isDefined(e, s))
                continue;
              var u = {};
              if (s === a.iconProperty)
                u = $("<img>")
                  .addClass("item item-" + s)
                  .attr("src", e[s]);
              else {
      ...
      (this.cache = {
        write: function (e, t, a, r) {
          if (i.cache.isSupported()) {
            ...
            var n = { value: t, timestamp: i.unixtime(), lifetime: a ? a : !1 };
        ...
        clear: function () {
          if (i.cache.isSupported()) {
            for (var e in localStorage)
              (e.indexOf(s) > -1 || e.indexOf("global") > -1) &&
                localStorage.removeItem(e);
            localStorage.clear();
          }
        },
        ...
        keyGen: function (e, t, i) {
          ...
          return (
            (i ? "global" : s) + ("0000000" + (n >>> 0).toString(16)).substr(-8)
          );
        },
      }),
      (this.options = {
      ...
      (this.isDup = function (e) {
        return this.options.get("allowDuplicateValues")
          ? !1
          : n.length > 0 && n.indexOf(this.fvalue.value(e)) > -1;
      }),
      ...
      e(document)
        ...
        .keydown(function (t) {
          ...
          if (0 !== s) {
            ...
            if (13 === l) t.preventDefault(), r.click();
            else if (40 === l || 38 === l) {
              t.preventDefault(),
                40 === l
                  ? (r =
                  ...
                  : 38 === l &&
                    (r =
                      n > 0 && r.prevAll(".item").first().length > 0
                        ? r
                            .removeClass("active")
                            .prevAll(".item")
                            .first()
