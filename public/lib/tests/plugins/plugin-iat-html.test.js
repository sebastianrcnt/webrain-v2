...
describe("iat-html plugin", function () {
  ...
  test("displays image by default", function () {
    ...
    document
      ...
      .dispatchEvent(new KeyboardEvent("keydown", { keyCode: 70 }));
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keyup", { keyCode: 70 }));
  ...
  test("display should only clear when left key is pressed", function () {
    ...
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keydown", { keyCode: 32 }));
    document
      .querySelector(".jspsych-display-element")
  ...
  test("display should only clear when right key is pressed", function () {
    ...
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keydown", { keyCode: 74 }));
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keyup", { keyCode: 74 }));
  ...
  test("should display wrong image when wrong key is pressed", function () {
    ...
    expect(
      jsPsych.getDisplayElement().querySelector("#wrongImgContainer").style
        .visibility
    ).toBe("hidden");
  ...
  test("should accept functions as parameters(trial_duration in use, response ends trial false)", function () {
    ...
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keydown", { keyCode: 73 }));
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keyup", { keyCode: 73 }));
  ...
  test("should accept functions as parameters(trial_duration is not in use)", function () {
    ...
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keydown", { keyCode: 69 }));
    document
      .querySelector(".jspsych-display-element")
      .dispatchEvent(new KeyboardEvent("keyup", { keyCode: 69 }));
